  ...
  <main class="app-main"> 
        ...
        <div class="app-content-header"> 
          ...
          <div class="container-fluid">
            <!--begin::Row--> 
            <div class="row"> 
              <div class="col-sm-6"><h3 class="mb-0">Data Fasilitas</h3></div> 
              <div class="col-sm-6"> 
    ...
    <a href="edit_fasilitas.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-warning no-1" title="edit">
      <i class="bi bi-pencil-square"></i></a>

    <a href="hapus_fasilitas.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-danger" title="hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
