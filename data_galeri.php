...
?> 
  <main class="app-main"> 
              ...
              <div class="col-12">                 
                ...
                <div class="card"> 
                  <div class="card-header"> 
                    <h3 class="card-title">Input Galeri</h3> 
    ...
    <a href="edit_galeri.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-warning no-1" title="edit">
      <i class="bi bi-pencil-square"></i></a>

    <a href="hapus_galeri.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-danger" title="hapus" onclick="return confirm('Yakin ingin menghapus data ini?')">
